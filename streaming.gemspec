...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'Make streaming'
  spec.description   = 'Streaming functionality for MT projects with analytics'
  ...
  spec.add_dependency 'chartjs-ror'
  spec.add_dependency 'dalli'
  spec.add_dependency 'ransack'
  spec.add_dependency 'rubyzip', '~> 1.1.0'
  spec.add_dependency 'sass'
  spec.add_dependency 'sass-rails'
  spec.add_dependency 'summernote-rails', '0.8.8.0'
